      ...
      <div className="flex justify-between items-center">
        ...
        <div className="max-w-3xl">
          ...
          <p className="text-gray-300 mb-6 leading-relaxed">
            Ushbu kurs JavaScript asoslarini biladiganlar uchun mo‘ljallangan
            bo‘lib, sizni TypeScript tilining imkoniyatlari bilan chuqur
            tanishtiradi. Asosiy va murakkab tiplar, interfeyslar, klasslar,
            generic'lar, conditional va mapped type'lar, dekoratorlar hamda
            modullilikni o‘rganasiz. Har bir modulda nazariy bilimlar va
            live-coding orqali amaliy mashg‘ulotlar mavjud. Yakunda siz
            kengaytiriladigan CLI-utility loyihasini ishlab chiqasiz va dizayn
            patternlari yordamida kuchli arxitekturani qurishni o‘rganasiz.
            Frontend va backend sohalarida TypeScript'ni jiddiy o‘rganmoqchi
            bo‘lganlar uchun ideal tanlov!
          </p>
